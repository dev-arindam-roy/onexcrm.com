...
<script src="{{ asset(config('onex.asset_path') . 'master-assets/js/action-functions.js') }}"></script>
<script src="{{ asset(config('onex.asset_path') . 'master-assets/js/signup-partial.js') }}"></script>
