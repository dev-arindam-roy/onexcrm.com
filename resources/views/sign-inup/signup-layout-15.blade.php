...
<style type="text/css">
.signup-box {
    box-shadow: #28a745 0px 1px 4px, #28a745 0px 0px 0px 3px;
}
</style>
@endpush

@section('page_content')
    <div class="container-fluid" id="signupLayout15">
        <div class="row justify-content-center mt-3">
            <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 p-0 mt-3 mb-2">
                <div class="card card-outline card-success signup-box">
                    <div class="card-header modify-card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p class="signinup-box-msg text-success text-right mr-2">Create an Account</p>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div id="emailRegistrationBox" style="display: none;">
                            <form name="signupFrm" id="msform" action="" method="post" autocomplete="off">
                                <ul id="signup-progressbar" class="signup-step-success">
                                ...
                                <fieldset class="mt-3 step-card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12 mt-0">
                                            <button type="button" id="step1Submit" class="next-btn btn btn-success">Next</button>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="mt-3 step-card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-0">
                                            ...
                                            <button type="button" id="step2Submit" class="next-btn btn btn-success">Next</button>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="mt-3 step-card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-0">
                                            ...
                                            <button type="button" id="step3Submit" class="next-btn btn btn-success">Next</button>
                                        </div>
                                    </div>
                                </fieldset>
