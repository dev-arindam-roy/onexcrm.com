...
<style type="text/css">
.body-bgcolor {
    background-image: url("master-assets/images/fullbg-2.jpg");
    height: 100%;
    width: 100%;
...
.signup-box {
    box-shadow: #007bff 0px 1px 4px, #007bff 0px 0px 0px 3px;
}
</style>
@endpush
                ...
                <div class="card card-outline card-primary signup-box">
                    <div class="card-header modify-card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p class="signinup-box-msg text-primary text-right mr-2">Create an Account</p>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-3 d-none" id="startAgain">
                            <a href="javascript:void(0);" class="text-center text-danger" id="startAgaingBtn">Cancel, start again?</a>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="text-center mt-0"><a href="" class="text-center">I already have an Account, Lets SignIn</a></div>
                    </div>
                </div>
            </div>
        </div>
