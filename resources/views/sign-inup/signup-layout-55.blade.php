...
@section('page_content')
    <div class="container-fluid" id="signupLayout55">
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form name="signupFrm" id="signupFrm" action="{{ route('signup.businessAccount.process') }}" method="POST" autocomplete="off">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="mcaptacha-box">
                                        {!! captcha_img('flat') !!}
                                        <a href="javascript:void(0);" id="reloadMcaptach" data-toggle="tooltip" data-placement="bottom" title="Reload the captach">
                                            <span class="ml-1"><i class="fas fa-sync"></i></span>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="mCaptcha" placeholder="Enter Captcha" maxlength="10" autocomplete="off" required="required">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
