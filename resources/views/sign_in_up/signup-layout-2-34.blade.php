...
@section('page_content')
    <div class="container-fluid" id="signupLayout234">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="text-primary mt-3 alex-box">
                                    <p class="text-center">Hey! I am <strong>Alex</strong><br/> Your <strong>CRM Manager</strong><br/>Let's Start...</p>
                                </div>
                            </div>
                            <div class="col-md-6">
