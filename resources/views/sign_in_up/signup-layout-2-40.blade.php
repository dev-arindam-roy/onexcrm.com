...
@section('page_content')
    <div class="container-fluid" id="signupLayout240">
                ...
                <div class="card card-outline card-primary signup-box">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post" autocomplete="off">
                            <!-- Nav tabs -->
                            <ul class="nav nav-pills nav-justified" id="signupTab">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#personalTab">Personal</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#accountTab">Account</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#securityTab">Security</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#businessTab">Business</a>
                                </li>
                            </ul>
                            <hr/>
                            <!-- Tab panes -->
