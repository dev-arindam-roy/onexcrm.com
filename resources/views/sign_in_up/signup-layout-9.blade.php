...
@section('page_content')
    <div class="container-fluid" id="signupLayout9">
...
$(function() {
    ...
    const instance = new Typewriter('#signupText', {
      strings: ['Hey bro,', 'Welcome to ONEX', 'Lets create a business account', 'Its Free', 'Manage your business with only 1 CRM - ONEX CRM', 'We are always ready to help you to grow your business', 'Thanks, see you again buddy.'],
      autoStart: true,
      loop: true
    });
